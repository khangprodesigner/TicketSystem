...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260909202816_InitialCreate'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20260909202816_InitialCreate', N'10.0.12');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260909220415_AddActionDateToHistory'
)
BEGIN
    ALTER TABLE [TicketHistories] ADD [ActionDate] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260909220415_AddActionDateToHistory', N'10.0.12');
END;
