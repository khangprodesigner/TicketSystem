...
namespace TicketSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260909220415_AddActionDateToHistory")]
    partial class AddActionDateToHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketSystem.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.Property<double?>("TotalDaysOrHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TicketSystem.Infrastructure.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TicketSystem.Infrastructure.Data.ApplicationUser", null)
                        .WithMany()
